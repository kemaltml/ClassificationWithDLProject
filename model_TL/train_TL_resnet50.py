...
train_dataset = CSVImageDataset('DataMining/labels_train.csv', '/content/drive/MyDrive/Projects/DataMining/Dataset/train/images', transform=transform)
valid_dataset = CSVImageDataset('DataMining/labels_valid.csv', '/content/drive/MyDrive/Projects/DataMining/Dataset/valid/images', transform=transform)
...
torch.save(model.state_dict(), 'models/resnet50_TL_model.pth')
